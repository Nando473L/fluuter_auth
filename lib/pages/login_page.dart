...
import 'package:verificacion/pages/registro_page.dart';
...
final GoogleSignIn _googleSignIn = GoogleSignIn(
  clientId: '871258935222-7jnq5nvnqoc3udqvevj7f21kvpvn6rt8.apps.googleusercontent.com',
);
          ...
          child: ElevatedButton(
            onPressed: () async {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const RegistroPage(), // Cambiar a la página RegistroPage
                ),
              );
            },
            style: ButtonStyle(
                backgroundColor:
                    MaterialStateProperty.all<Color>(const Color(0xff142047))),
            child: const Text(
              "Registrarse", // Cambiar el texto del botón a "Registrarse"
              style: TextStyle(color: Colors.white),
            ),
          ),
        ),
